					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li>
									<a href="client-new.html"><i class="fas fa-plus fa-fw"></i> &nbsp; Ingresar Datos</a>
								</li>
		...
		<section class="full-box page-content">
           ...
           <align=center></align>
			...
			<div class="full-box page-header">
                ...
                <p clas =text-justify>
                <h5>En este menu Ud podra hacer las diferentes tareas puestas para que su ingreso de datos sea satisfactorio</h5>
                    </p>
			</div>
			...
			<div class="full-box tile-container">
				...
				<a href="solicitudDeMediacion.php" class="tile">
					<div class="tile-tittle">NUEVO</div>
					<div class="tile-icon">
				...
				<a href="item-list.html" class="tile">
					<div class="tile-tittle">VER LISTA</div>
					<div class="tile-icon">
				...
				<a href="reservation-list.html" class="tile">
					<div class="tile-tittle">BUSQUEDA</div>
					<div class="tile-icon">
