...
<head>
    ...
    <!-- Title -->
    <title>Centro de Mediacion - Pasaje 2021</title>
...
<body>
                    ...
                    <div class="col-12 h-100">
                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                            ...
                            <div class="login-content">
                                <a href="./verificaAdmin.php">Entrar al Sistema</a>
								<a href="verificarAdminReg.php">/Registro  </a>
                            </div>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#">CENTRO DE MEDIACIÓN</a>
                                        <ul class="dropdown">
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <!-- Single Hero Slide    1ra imagen de la portada que se mueve CARRUSEL-->
            <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/balanza.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h4 data-animation="fadeInUp" data-delay="100ms">CENTRO DE MEDIACION PASAJE 2021</h4>
                                <h2 data-animation="fadeInUp" data-delay="400ms">BIENVENIDO <br>CONTAMOS CON VARIOS SERVICIOS LEGALES </h2>
            ...
            <!-- Single Hero Slide  SEGUNDA IMAGEN DEL CARRUCEL DE IMAGENES -->
            <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/mediacion.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h4 data-animation="fadeInUp" data-delay="100ms">CENTRO DE MEDIACION PASAJE 2021</h4>
                                <h2 data-animation="fadeInUp" data-delay="400ms">CONTAMOS CON PROFESIONALES CALIFICADOS<br>ESTAMOS PARA AYUDARTE</h2>
                                <a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">leer mas</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="800ms">
                        ...
                        <div class="course-content">
                            <h4>CONVIVENCIA SOCIAL O VECINAL</h4>
                            <p></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cta-content d-flex align-items-center justify-content-between flex-wrap">
                        <h3>Quieres saber mas ponte en contacto con nosotros</h3>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="footer-widget mb-100">
                            <div class="widget-title">
                                <a href="#"><img src="img/core-img/logo-ftn.png" alt=""></a>
                            </div>
