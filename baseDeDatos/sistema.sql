...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-08-2021 a las 05:57:42
...
('DOC-000003', 'DFBFDFDF', '2021-07-11 19:00:48', 3, 2, 1, 'ACEPTADO', 'C', 'Archivo/60eb3fe0e504b-AGENDA SEMANA 9  INICIAL 5-9 julio 4 años.pdf');
...
(1, 'Estalin', 'Alvarado', 'Vaca', '07043078', 'M', '1982-02-18', 'Bolivar y Colon', '939918569', '982255930', 'estalinalvarado@gmail.com', '2018-11-14 07:27:52', 'ACTIVO', 1, 'DIRECTOR'),
...
--
-- Estructura de tabla para la tabla `registrodeusuario`
--
...
CREATE TABLE `registrodeusuario` (
  ...
  `numeroTelf` varchar(20) NOT NULL,
  `clave` varchar(10) NOT NULL,
  `clave2` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `registrodeusuario`
--

INSERT INTO `registrodeusuario` (`id`, `nombreUsu`, `cedula`, `nombres`, `apellidos`, `correo`, `numeroTelf`, `clave`, `clave2`) VALUES
(43, 'Estalin Alvarado', '0704307842', 'Estalin', 'Alvarado', 'estalinalvarado@gmail.com', '0939918569', '123', '123'),
(44, '', '', '', '', '', '', '', ''),
(45, '', '', '', '', '', '', '', ''),
(46, 'jkjkljkl', '789789', 'khkhk', 'hkjhkjh', 'sdfdsf@hotmail.com', '897987', '123', '123'),
(47, 'Estalin', '6546', 'tytyt', 'tryrtyr', 'jgjg@hotmail.com', '454654654', '123', '123'),
(48, '', '', '', '', '', '', '', ''),
(49, '', '', '', '', '', '', '', ''),
(50, '', '', '', '', '', '', '', ''),
(51, '', '', '', '', '', '', '', ''),
...
(59, '', '', '', '', '', '', '', ''),
(60, '', '', '', '', '', '', '', ''),
(61, 'admin', '78789', 'Estalin', 'Alvarado', 'estalinalvarado@gmail.com', '0939918569', '123', '123');
...
--
-- Indices de la tabla `registrodeusuario`
--
ALTER TABLE `registrodeusuario`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `solicitud_mediacion`
--
ALTER TABLE `solicitud_mediacion`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `registrodeusuario`
--
ALTER TABLE `registrodeusuario`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT de la tabla `solicitud_mediacion`
--
ALTER TABLE `solicitud_mediacion`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=643;
