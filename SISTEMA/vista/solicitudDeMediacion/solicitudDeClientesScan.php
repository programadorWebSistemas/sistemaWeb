...
<body class="hold-transition sidebar-mini layout-fixed">
 ...
 <form class="form-horizontal" action="../../controlador/subirArchivoEscanAdmin.php" method="post" enctype="multipart/form-data"> 
		<div class="card-body">
                <div class="row">
                  <div class="col-3">
				...
				while($row=mysqli_fetch_assoc($resultado)){ ?>
					<tr class="text-center" >
							...
							<td><?php echo $row["fecha"];?></td>	
								...
								<td>
									<a href="../../controlador/eliminarArchivosScan.php? expediente=<?php echo $row["expediente"];?>" class="btn btn-danger" >
