      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" _msthidden="13">
          ...
          <a href="#" class="dropdown-item" _msthidden="4">
            <!-- Message Start -->
            <div class="media" _msthidden="4">
              <img src="#" alt="User Avatar" class="img-size-50 img-circle mr-3" _msthidden="A" _msthiddenattr="1477346" _mstalt="154167">
              <div class="media-body" _msthidden="3">
				...
				<div class="table-responsive">
					<table class="table table-dark table-sm">
								...
								<tr class="text-center" >
										<td><?php echo $row["numeroEpxSolicitud"];?></td>
										<td><?php echo $row["cedula"];?></td>
										<td><?php echo $row["nombres"];?></td>
										<td><?php echo $row["apellidos"];?></td>
										<td><?php echo $row["correo"];?></td>
										<td><?php echo $row["numeroTelfC"];?></td>
									...
									<td>
									<a href="../../controlador/pdfBuscar.php? numeroEpxSolicitud=<?php echo $row["numeroEpxSolicitud"];?>" class="btn btn-success" target="_blank">
	  									<i class="fas fa-sync-alt"></i>	
									</a>
								...
								<td>
									...
									<a href="../controlador/eliminar_reg_solicitud.php? numeroEpxSolicitud=<?php echo $row["numeroEpxSolicitud"];?>" class="btn btn-danger" >
